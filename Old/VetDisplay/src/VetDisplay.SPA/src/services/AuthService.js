...
class AuthService {
    ...
    login(selectedProvider) {
        ...
        var popup = window.open(provider.endpoint, "Connexion à VetDisplay", "menubar=no, status=no, scrollbars=no, menubar=no, width=700, height=700");
    }
    ...
    logout() {
        var popup = window.open(this.logoutEndpoint, "Déconnexion de VetDisplay", "menubar=no, status=no, scrollbars=no, menubar=no, width=700, height=600");
    }
